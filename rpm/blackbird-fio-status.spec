...
%define name blackbird-fio-status
...
Summary: Get information by fio-status.
Name: %{name}
Version: %{version}
...
* Project Page: https://github.com/Vagrants/blackbird-fio-status
...
cp -p fio_status.cfg $RPM_BUILD_ROOT/%{blackbird_conf_dir}/fio_status.cfg
...
%changelog
* Wed Jan  7 2015 makocchi <makocchi@gmail.com> - 0.1.0-1
- first package
